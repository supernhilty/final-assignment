...
<body>
  ...
  <body>
    <section class="question">
      <h1></h1>
<div class="question">
        <p><strong onclick="toggleAnswer(1)">[New Member] What is Pet Coin?</strong></p>
      <ul id="answer-1" class="answer">
          <li>1. Use Pet Coin to pay for purchases on the shop:</li>
          <li> If both Pet Coin and Voucher are used in a single order, the system will apply the discounts in the following order: Voucher > Pet Coin</li>
          <li> Pet Coin will be refunded to the User's Pet Coin section if the order using Pet Coin discounts is canceled, returned, or refunded</li>
          <li> Conditions for applying free shipping codes</li>
          <li>2. Use Pet Coin to exchange for Vouchers / Discount codes:</li>
          <li> Please carefully check the Terms and Conditions of each discount Voucher before exchanging to ensure that you can receive the most suitable discount Voucher for your shopping needs.</li>
          <li> Once used to exchange for a discount Voucher, your Pet Coin cannot be refunded even if you do not use that Voucher or when the Voucher expires.</li>
          <li> Use Pet Coin to exchange for Pet Hello Rewards</li>
        </ul>
      </div>
