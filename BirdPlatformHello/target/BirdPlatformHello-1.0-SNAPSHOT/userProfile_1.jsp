                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    ...
                                                    <input minlength="10" maxlength="10"  name="PhoneNumber" type="text" id="input-last-name" class="form-control form-control-alternative" placeholder="Phone Number" value="${sessionScope.CUSTOMERDTO.phonenumber}">
                                                </div>
                                            </div>
                                            </form>
