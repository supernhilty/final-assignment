...
<html lang="en">
    ...
    <body>
        ...
        <c:if test="${requestScope.totalpagebestseller >1}">
            <div class="pagination">
                ...
                <c:forEach var="page" begin="1" end="${requestScope.totalpagebestseller}">
                ...
                <c:if test="${requestScope.currentpage<requestScope.totalpagebestseller}">
